 ...
 */
public class AddActividadesActivity extends Activity implements View.OnClickListener {
...
//Se recogen los datos seleccionados
    @Override
...
// Se inserta en la BBDD datos recogidos
                dbManager.insert(name, desc,prioridad,fecha,hora);
// Se vuelva a la actividad principal
    ...
    public void addFecha(View v) {
        // Abrir activity calendario y añadir fecha al et
    ...
    // abrir TimePicer y añadir hora a et
